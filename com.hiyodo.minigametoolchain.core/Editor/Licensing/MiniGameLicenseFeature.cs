...
namespace MiniGame.Core.Editor.Licensing
{
    ...
    public static class MiniGameLicenseFeature
    {
        ...
        public const string PerformanceSuiteResourceWaterfall = "PerformanceSuite.ResourceWaterfall";
        public const string PerformanceSuiteReportSharing = "PerformanceSuite.ReportSharing";
        public const string PerformanceSuiteHotspots = "PerformanceSuite.Hotspots";
        public const string PerformanceSuiteMemoryDeepAnalysis = "PerformanceSuite.MemoryDeepAnalysis";
        ...
        public const string StarterKitLocalization = "StarterKit.Localization";
        public const string StarterKitCdnLoader = "StarterKit.CdnLoader";
