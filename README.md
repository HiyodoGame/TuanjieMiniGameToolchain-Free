...
Download `free-upm-bundle-0.3.0.zip` from Releases, extract it, and add each package folder via **Add package from disk...**.

从 Releases 下载 `free-upm-bundle-0.3.0.zip`，解压后通过 **Add package from disk...** 逐个添加。
