...
- **Version / 版本**: 0.1.2
- **Published / 发布日期**: 2026-07-13

- `com.minigame.build-optimizer`
- `com.minigame.core`
- `com.minigame.performance-suite`
- `com.minigame.starter-kit`
...
打开 **Window → Package Manager**，点击 **+ → Add package from git URL...**，输入上述地址。按需安装其他包，注意必须先安装 `com.minigame.core`，其他包依赖它。

Available package paths / 可用包路径：

```
Packages/com.minigame.core
Packages/com.minigame.build-optimizer
Packages/com.minigame.performance-suite
Packages/com.minigame.starter-kit
```
...
Download `free-upm-bundle-0.1.2.zip` from Releases, extract it, and add each package folder via **Add package from disk...**.

从 Releases 下载 `free-upm-bundle-0.1.2.zip`，解压后通过 **Add package from disk...** 逐个添加。
